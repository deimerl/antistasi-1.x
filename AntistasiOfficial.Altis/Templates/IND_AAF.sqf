...
sol_LAT3 = 	"I_Soldier_LAT2_F";         // Light AT (tankdlc)
...
vehPatrol =			["I_MRAP_03_F","I_MRAP_03_hmg_F","I_MRAP_03_gmg_F","I_LT_01_cannon_F","I_Heli_light_03_dynamicLoadout_F","I_Heli_Transport_02_F"]; 			// selectrandom
vehAPC = 			["I_APC_Wheeled_03_cannon_F"]; 																// selectrandom
vehIFV = 			["I_APC_tracked_03_cannon_F","I_LT_01_cannon_F"]; 																// selectrandom
...
planes = 			["I_Plane_Fighter_03_CAS_F","I_Plane_Fighter_03_AA_F","I_Plane_Fighter_04_F"];; // attack planes
